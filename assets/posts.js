...
const POSTS = [
  {
    date: "2026-08-28",
    title: "친절한 AI, 아이는 믿어도 될까? 기술의 끝은 다시 사람에게 닿아야 한다",
    subtitle: null,
    summary: "AI 장난감과 아이의 신뢰, 교사 매개형 화면 없는 AI 수업, 문화적으로 반응적인 수업안 검토, 함께 읽기와 AI 그림책 품질을 살핍니다. AI가 아이와 관계를 대신하기보다 교사와 부모의 판단을 돕고 실제 대화와 놀이로 돌려보내야 한다는 기준을 제안합니다.",
    tags: ["일일 브리핑","AI 신뢰","교사 매개","관계 중심"],
    pdf: "pdfs/2026-08-28.pdf",
    thumb: "assets/thumbs/2026-08-28.jpg",
  },
  {
    date: "2026-08-12",
    title: "AI 딸깍 말고, 어른의 판단이 더 중요하다",
    subtitle: null,
    summary: "STEM을 받아들이며 교사가 자신의 정체성을 다시 구성하는 과정, 부모 중심 감정코칭 AI, 예비교사의 수업계획, AI 이미지 편향을 살핍니다. 유아·초등 저학년 AI 교육 제안은 확정 정책이 아닌 국민제안 단계임을 구분하고, AI 활용 전후 아이의 놀이·대화·관계 변화를 점검합니다.",
    tags: ["일일 브리핑","AI 유아교육","교사 판단","부모 중심 AI"],
    pdf: "pdfs/2026-08-12.pdf",
    thumb: "assets/thumbs/2026-08-12.jpg",
  },
  {
    date: "2026-08-11",
    title: "아이를 돕는 답은 어디에 있을까? 관계와 환경을 함께 봐야 보인다",
    subtitle: null,
    summary: "교사 150명의 AI 컨퍼런스와 인도의 대상별 AI 문해력부터 수학 그림책, 또래 언어환경, 교사의 마음읽기, 부모-아이 공동연습까지 살핍니다. 아이를 이해하려면 한 사람이나 한 가지 도구가 아니라 관계와 생활환경을 함께 보아야 합니다.",
    tags: ["일일 브리핑","AI 유아교육","관계와 환경","부모-아이 공동연습"],
    pdf: "pdfs/2026-08-11.pdf",
    thumb: "assets/thumbs/2026-08-11.jpg",
  },
  {
    date: "2026-08-06",
    title: "AI가 여러 일을 해낼수록, 교사는 무엇을 더 잘해야 할까?",
    subtitle: "아이의 맥락을 읽고 멈추고 다시 결정하는 사람",
    summary: "교육용 AI가 자료와 앱을 연결해 여러 단계를 수행하는 흐름 속에서 교사의 판단권, 접근성, 개인정보 보호와 사람 관계를 살펴봅니다. AI가 더 많은 일을 맡을수록 목적을 정하고 결과를 검토하며 책임지는 사람의 역할은 더 분명해야 합니다.",
    tags: ["일일 브리핑","AI 유아교육","교사 판단","사람 관계"],
    pdf: "pdfs/2026-08-06.pdf",
    thumb: "assets/thumbs/2026-08-06.jpg",
  },
  {
    date: "2026-08-05",
    title: "AX, 유아기 아이에게 필요한 힘은 무엇일까?",
    subtitle: "도구를 누르는 법보다, 질문하고 다시 판단하는 경험",
    summary: "유아기 AI 교육에서 화면 조작보다 질문이 먼저여야 하는 이유를 살핍니다. 신뢰 가능한 AI의 책임 구조, 교사가 매개하는 AI 이야기, 관찰과 최종 판단을 사람에게 남기는 기준, 부모와 현장 교사의 인식까지 연결했습니다.",
    tags: ["일일 브리핑","AI 유아교육","교사 매개","사람의 판단"],
    pdf: "pdfs/2026-08-05.pdf",
    thumb: "assets/thumbs/2026-08-05.jpg",
  },
  {
    date: "2026-07-24",
