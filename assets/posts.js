...
const POSTS = [
  {
    date: "2026-08-28",
    title: "친절한 AI, 아이는 믿어도 될까?",
    subtitle: null,
    summary: "AI 인형이 충전기를 찾아 달라고 하자 다섯 살 아이는 혼자 집 안을 돌아다녔습니다. 아이는 다정하게 반응하는 AI를 언제, 왜 믿을까요? 화면 없는 교사 매개 수업과 문화적 오류 검수 사례를 통해 AI가 언제 대화를 멈추고 어른에게 확인하게 해야 하는지 살핍니다.",
