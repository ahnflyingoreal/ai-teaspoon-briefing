...
const POSTS = [
  {
    date: "2026-08-12",
    title: "AI가 대신해 주면 편할 줄 알았다",
    subtitle: "그런데 어른의 일이 더 중요해졌다",
    summary: "STEM을 받아들이는 유아교사의 정체성, 부모 중심 감정코칭 AI, 예비교사의 수업계획, AI 이미지 편향과 유아용 AI 원칙을 깊게 연결합니다. AI가 아이를 대신 가르치는 것보다 교사와 부모가 결과를 고르고 고치는 힘에 주목합니다.",
  ...
  {
    date: "2026-08-11",
    title: "아이를 돕는 답은 어디에 있을까?",
    subtitle: "관계와 환경을 함께 봐야 보인다",
